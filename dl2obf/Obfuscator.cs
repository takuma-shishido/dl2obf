...
namespace dl2obf
{
    class Obfuscator
    {
        ...
        public void ObfuscateClassName(TypeDefinition c)
        {
            ...
            c.Name = "C" + StringObfuscator.ObfuscateString(c.Name);
        ...
        public void ObfuscateFieldName(FieldDefinition f)
        {
            ...
            f.Name = "F" + StringObfuscator.ObfuscateString(f.Name);
        ...
        public void ObfuscatePropertyName(PropertyDefinition p)
        {
            ...
            p.Name = "P" + StringObfuscator.ObfuscateString(p.Name);
        ...
        public void ObfuscateMethodName(MethodDefinition m)
        {
            ...
            m.Name = "M" + StringObfuscator.ObfuscateString(m.Name);
        ...
        private void ObfuscateParameterNames(MethodDefinition m)
        {
            foreach (var p in m.Parameters)
            {
                ...
                p.Name = StringObfuscator.ObfuscateString(p.Name);
                Console.WriteLine($"'{p.Name}'");
            }
        }
